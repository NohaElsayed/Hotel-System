...
@section('title') Noha | Home @endsection

@section('description') Hotel Noha, the most luxuriest hotel in the world@endsection
    ...
    <section class="hero-section odvoji">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="hero-text">
                        <h1>NohaHotel A Luxury Hotel</h1>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-text">
                        ...
                        <p class="f-para">nohaelsayed123@gmail.com is a leading online accommodation site. We’re passionate about travel. Every day, we inspire and reach millions of travelers across 90 local websites in 41
                            languages.</p>
